...
pub fn get_node_id_metric(client: &'a mut hyper::Client, base: String,
...
pub fn get_metric_index_metric(client: &'a mut hyper::Client, base: String,
...
pub fn get_node_id_metric_index_metric(client: &'a mut hyper::Client,
                                   base: String, node_id: String,
                                   metric: String, index_metric: String)
 -> Result<Response>{
    let mut url_fmtd =
