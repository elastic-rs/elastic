...
pub fn put_index<'a>(client: &'a mut Client,
                     base: &'a str,
                     index: &'a str,
                     body: String)
                     -> Result<Response> {
    let mut url_fmtd = String::with_capacity(base.len() + 1 + 6 + index.len());
...
pub fn post_index_type<'a>(client: &'a mut Client,
                           ...
                           body: String)
                           -> Result<Response> {
    let mut url_fmtd = String::with_capacity(base.len() + 1 + 1 + 6 + index.len() + _type.len());
    url_fmtd.push_str(base);
    url_fmtd.push_str("/");
    url_fmtd.push_str(index);
    url_fmtd.push_str("/");
...
pub fn put_index_type<'a>(client: &'a mut Client,
                          base: &'a str,
                          index: &'a str,
                          _type: &'a str,
                          body: String)
...
pub fn put<'a>(client: &'a mut Client, base: &'a str, body: String) -> Result<Response> {
    let mut url_fmtd = String::with_capacity(base.len() + 6);
    url_fmtd.push_str(base);
    url_fmtd.push_str("/_bulk");
    let mut headers = Headers::new();
