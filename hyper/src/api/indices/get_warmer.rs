...
pub fn get_index<'a>(client: &'a mut Client, base: &'a str, index: &'a str) -> Result<Response> {
    let mut url_fmtd = String::with_capacity(base.len() + 1 + 8 + index.len());
...
pub fn get_name<'a>(client: &'a mut Client, base: &'a str, name: &'a str) -> Result<Response> {
...
pub fn get_index_name<'a>(client: &'a mut Client,
                          base: &'a str,
                          index: &'a str,
                          name: &'a str)
                          -> Result<Response> {
    let mut url_fmtd = String::with_capacity(base.len() + 1 + 9 + index.len() + name.len());
    url_fmtd.push_str(base);
    url_fmtd.push_str("/");
    url_fmtd.push_str(index);
    url_fmtd.push_str("/_warmer/");
...
pub fn get_index_type_name<'a>(client: &'a mut Client,
                               base: &'a str,
                               index: &'a str,
                               _type: &'a str,
                               name: &'a str)
                               -> Result<Response> {
    let mut url_fmtd = String::with_capacity(base.len() + 1 + 1 + 9 + index.len() + _type.len() +
                                             name.len());
    url_fmtd.push_str(base);
    url_fmtd.push_str("/");
    url_fmtd.push_str(index);
