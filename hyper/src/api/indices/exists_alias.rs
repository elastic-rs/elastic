...
pub fn head_index_name<'a>(client: &'a mut Client,
                           base: &'a str,
                           index: &'a str,
                           name: &'a str)
                           -> Result<Response> {
...
pub fn head_index<'a>(client: &'a mut Client, base: &'a str, index: &'a str) -> Result<Response> {
...
pub fn head_name<'a>(client: &'a mut Client, base: &'a str, name: &'a str) -> Result<Response> {
