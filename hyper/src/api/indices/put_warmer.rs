...
pub fn put_index_type_name<'a>(client: &'a mut Client, base: String,
                           index: String, _type: String, name: String,
...
pub fn post_index_type_name<'a>(client: &'a mut Client, base: String,
                            index: String, _type: String, name: String,
                            body: String) -> Result<Response>{
    let mut url_fmtd =
        String::with_capacity(base.len() + 1 + 1 + 10 + index.len() +
