...
pub fn post_scroll_id<'a>(client: &'a mut Client, base: &'a str,
                      scroll_id: &'a str, body: String) -> Result<Response>{
    let mut url_fmtd =
...
pub fn get_scroll_id<'a>(client: &'a mut Client, base: &'a str,
...
pub fn post<'a>(client: &'a mut Client, base: &'a str, body: String)
 -> Result<Response>{
    let mut url_fmtd = String::with_capacity(base.len() + 15);
    url_fmtd.push_str(base);
    url_fmtd.push_str("/_search/scroll");
