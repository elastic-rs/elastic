...
//! The functions are also designed to work well with the `elastic_types` and `elastic_types_codegen` crates, but deserialisation is the responsibility of the caller.
//! 
//! # Links
