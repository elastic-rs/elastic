    ...
    for endpoint in parsed {
        ...
        for fun in fun_sigs {            
            ...
            let mut rs_fun = build_fn(&fun.name, vec![
                build_arg(_client, build_ty_ptr("hyper::Client", Mutability::Mutable, Some(lifetime))),
            ...
            //TODO: Check if UrlFn has body: add body arg and ident
            //TODO: Use appropriate hyper method for method
