...
mod tests {
    ...
    fn parse_basic_date_time() {
        assert_parse(b"yyyyMMdd'T'HHmmss.SSSZ",
                     vec![Year,
                          Month,
                          DayOfMonth,
                          Escaped("T"),
    ...
    fn parse_basic_date_time_no_millis() {
        assert_parse(b"yyyyMMdd'T'HHmmssZ",
                     vec![Year, Month, DayOfMonth, Escaped("T"), Hour, Minute, Second, Utc]);
    }
    ...
    fn parse_date_hour_minute_second_millis() {
        assert_parse(b"yyyy-MM-dd'T'HH:mm:ss.SSS",
                     vec![Year,
                          Delim("-"),
                          Month,
                          Delim("-"),
