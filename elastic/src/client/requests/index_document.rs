...
mod tests {
    ...
    fn default_request() {
        ...
        let req = client.index_document(index("test-idx"), id("1"), Value::Null).req.into_request().unwrap();
    ...
    fn specify_ty() {
        ...
        let req = client.index_document(index("test-idx"), id("1"), Value::Null)
            .ty("new-ty")
            .req
            .into_request()
            .unwrap();
    ...
    fn document_borrow() {
        ...
        let doc = Value::Null;
        let req = client.index_document(index("test-idx"), id("1"), &doc).req.into_request().unwrap();
