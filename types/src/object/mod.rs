...
//! ## Derive Mapping
//!
//! Mapping can be generated by deriving `ElasticFieldType` on a struct:
//!
//! ```
//! # #![feature(proc_macro)]
//! # #[macro_use]
...
//! }
//!
//! //Implement ElasticFieldType for your type. This binds it to the mapping
//! impl ElasticFieldType<MyTypeMapping, ObjectFormat> for MyType { }
//!
...
impl<T, M> ElasticFieldType<M, ObjectFormat> for T
    where T: ElasticUserType<M>,
          M: ObjectMapping
{
}
